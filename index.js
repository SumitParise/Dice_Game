...
var randomImages1 = "/images/dice"+ randomNumber1 +".png"; //Using random number to create random images with source of images

var randomImages2 = "/images/dice"+ randomNumber2 +".png"; //Using random number to create random images with source of images
